  ...
  "node_modules/react-dom/cjs/react-dom-server-legacy.browser.development.js"(exports) {
    ...
    (function() {
      ...
      function fatalError(request, error) {
        ...
        onShellError(error);
        onFatalError(error);
        null !== request.destination ? (request.status = CLOSED, request.destination.destroy(error)) : (request.status = 2, request.fatalError = error);
      }
              ...
              a: if (null !== task.replay) {
                ...
                if (null !== request.trackedPostpones) {
                  ...
                  try {
                    ...
                    throw boundarySegment.status = 1 === request.status ? 3 : 4, thrownValue;
                  } finally {
          ...
          if ("object" === typeof node) {
            switch (node.$$typeof) {
              case REACT_ELEMENT_TYPE:
                ...
                var name = getComponentNameFromType(type), keyOrIndex = null == key ? -1 === childIndex ? 0 : childIndex : key, keyPath = [task.keyPath, name, keyOrIndex];
                if (null !== task.replay) {
      ...
      function abortTask(task, request, error) {
        ...
        if (null === boundary) {
          if (boundary = {}, 2 !== request.status && request.status !== CLOSED) {
            ...
            task.pendingTasks--;
            0 === task.pendingTasks && 0 < task.nodes.length && (segment = logRecoverableError(request, error, boundary), abortRemainingReplayNodes(
              request,
              null,
              task.nodes,
              task.slots,
          ...
          boundary.pendingTasks--, task = getThrownInfo(task.componentStack), boundary.status !== CLIENT_RENDERED && (boundary.status = CLIENT_RENDERED, segment = logRecoverableError(request, error, task), boundary.status = CLIENT_RENDERED, encodeErrorForBoundary(boundary, segment, error, task, true), untrackBoundary(request, boundary), boundary.parentFlushed && request.clientRenderedBoundaries.push(boundary)), boundary.fallbackAbortableTasks.forEach(function(fallbackTask) {
              ...
              if (null === segment) {
                  ...
                  try {
                    ...
                    if ("object" === typeof x && null !== x && "function" === typeof x.then) {
                      ...
                      erroredReplay(
                        ...
                        1 === request$jscomp$0.status ? request$jscomp$0.fatalError : x,
                        errorInfo,
                ...
                if (segment$jscomp$0.status === PENDING) {
                  ...
                  try {
                    ...
                    var x$jscomp$0 = thrownValue === SuspenseException ? getSuspendedThenable() : 1 === request.status ? request.fatalError : thrownValue;
      ...
      function startWork(request) {
        ...
        null !== request.trackedPostpones ? performWork(request) : (performWork(request), safelyEmitEarlyPreloads(request, 0 === request.pendingRootTasks));
      }
      ...
      }, callLazyInitInDEV = callLazyInit["react-stack-bottom-frame"].bind(callLazyInit), CLIENT_RENDERED = 4, PENDING = 0, COMPLETED = 1, FLUSHED = 2, POSTPONED = 5, CLOSED = 3, currentRequest = null, didWarnAboutBadClass = {}, didWarnAboutContextTypes = {}, didWarnAboutContextTypeOnFunctionComponent = {}, didWarnAboutGetDerivedStateOnFunctionComponent = {}, didWarnAboutReassigningProps = false, didWarnAboutGenerators = false, didWarnAboutMaps = false;
...
var require_react_dom_server_browser_development = __commonJS({
  "node_modules/react-dom/cjs/react-dom-server.browser.development.js"(exports) {
    ...
    (function() {
      ...
      function pingTask(request, task) {
        request.pingedTasks.push(task);
        1 === request.pingedTasks.length && (request.flushScheduled = null !== request.destination, null !== request.trackedPostpones ? scheduleMicrotask(function() {
      ...
      function fatalError(request, error) {
        ...
        onShellError(error);
        onFatalError(error);
        null !== request.destination ? (request.status = CLOSED, closeWithError(request.destination, error)) : (request.status = 2, request.fatalError = error);
      }
      function renderWithHooks(request, task, keyPath, Component, props, secondArg) {
        var prevThenableState = task.thenableState;
        task.thenableState = null;
      ...
      function startWork(request) {
        request.flushScheduled = null !== request.destination;
        null !== request.trackedPostpones ? scheduleMicrotask(function() {
          return performWork(request);
        }) : (scheduleWork(function() {
          return performWork(request);
        }), scheduleWork(function() {
